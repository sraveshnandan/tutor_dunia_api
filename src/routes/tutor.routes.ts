...
TutorRouter.route("/tutor/profile").post(Authenticate as any, FetchTutorProfile as any);
TutorRouter.route("/tutor/update").post(Authenticate as any, UpdateTutorProfile as any);
